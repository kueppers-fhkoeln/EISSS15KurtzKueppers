...
app.post('/fahrtmenue', function(req, res){
    console.log("Fahrtmenü wird aufgerufen!");
...
app.post('/fahrtauswahl', function(req, res){
    console.log("Fahrtauswahl wurde getroffen!");
...
app.post('/getDriver', function(req, res){
    console.log("Nachricht an Fahrer wird aufgerufen!");
...
app.post('/sendMessage', function(req, res){
    console.log("Eine Nachricht wurde an den Fahrer verschickt!");
    store.saveMessage({
        fid     : req.body.f_id,
        mid     : req.body.p_id,
        eid     : req.body.e_id,
...
app.post('/sendGPS', function(req, res){
    console.log("GPS Daten wurden weitergeleitet!");
    store.saveGPS({
        pid          : req.body.p_id,
        eid          : req.body.e_id,
