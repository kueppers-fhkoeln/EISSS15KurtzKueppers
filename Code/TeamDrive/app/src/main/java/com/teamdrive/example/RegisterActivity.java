...
public class RegisterActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        autoET = (EditText)findViewById(R.id.registerAuto);
	...
	public void registerUser(View view){
        ...
        String auto = autoET.getText().toString();
        String plaetze = plaetzeET.getText().toString();
		...
		if(Utility.isNotNull(mannschaft) && Utility.isNotNull(vorname) && Utility.isNotNull(nachname) && Utility.isNotNull(tel)
			...
			if(Utility.validate(email)){
                ...
                params.put("straße", strasse);
                params.put("stadt", stadt);
                params.put("auto", auto);
                params.put("sitzplätze", plaetze);
	...
	public void invokeWS(RequestParams params){
        ...
        client.get("http://192.168.178.207:3000/register",params ,new AsyncHttpResponseHandler() {
            	...
            	// Verstecke Progress Dialog
                 ...
                 try {
                         ...
                         if(obj.getBoolean("status")){
                        	 ...
                        	 setDefaultValues();
                        	 // Toast beim erfolgreichem registrieren
